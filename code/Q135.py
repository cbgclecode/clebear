...
_question_id = 135
_question__title = "Candy"
_question__title_slug = "candy"
_difficulty_level = "3"
_question_url = "https://leetcode-cn.com/problems/candy"
...
def judge(solution=None, method=None, io_equal=None):
    ...
    assert method([1, 0, 2]) == 5
    assert method([1, 2, 2]) == 4
    pass
