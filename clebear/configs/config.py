...
class LeetCode:
    def __init__(self):
        ...
        self.PATH_CODE = os.path.join(self.PATH_PROJECT, "code")
        self.PATH_CODE_PRACTICE = os.path.join(self.PATH_PROJECT, "code-practice")
        self.PATH_PROBLEMS_JSON = os.path.join(self.PATH_ROOT, "datas/all-questions.json")
